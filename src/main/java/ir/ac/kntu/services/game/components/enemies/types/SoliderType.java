...
public class SoliderType implements EnemyType {
    private static final String SOLIDER_BASE_PATH = "/game/components/enemies/overlays/solider.png";
    private static final Image SOLIDER_BASE_IMAGE = new Image(SOLIDER_BASE_PATH);
    private static final String SOLIDER_OVERLAY_PATH = "/game/components/enemies/bases/empty.png";
